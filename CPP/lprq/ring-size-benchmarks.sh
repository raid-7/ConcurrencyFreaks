...

{
  ...
  "$PC_BENCH" -f cpp-res-rs-p1c1b.csv -t 8 8 24 24 -w 8 -r 16 64 256 512 1024 2048 4096 8192 16384 -b "$@"
  ...
  "$PC_BENCH" -f cpp-res-rs-p2c1b.csv -t 10 5 32 16 -w 8 -r 16 64 256 512 1024 2048 4096 8192 16384 -b "$@"
  "$PC_BENCH" -f cpp-res-rs-p1c2b.csv -t 5 10 16 32 -w 8 -r 16 64 256 512 1024 2048 4096 8192 16384 -b "$@"
